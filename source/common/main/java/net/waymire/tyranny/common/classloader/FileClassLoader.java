		...
		for (File file : fileList) {
			if (file.isFile()) {
				try {
					...
					LOGGER.log(Level.WARNING, ExceptionUtil.getReason(ioe));
					LOGGER.log(Level.WARNING, ExceptionUtil.getStackTrace(ioe));
				}
			}
		...
		for (File file : fileList) {
			...
			if (file.isDirectory()) {
				...
				if (f != null) 
				{
					...
					{
						LOGGER.log(Level.WARNING,ExceptionUtil.getReason(mue));
						LOGGER.log(Level.WARNING,ExceptionUtil.getStackTrace(mue));
					}
				}
			}
		}

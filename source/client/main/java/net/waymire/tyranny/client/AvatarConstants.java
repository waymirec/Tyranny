...
public class AvatarConstants 
{
    ...
    public static final Quaternion ROT_LEFT = new Quaternion().fromAngleAxis(FastMath.PI/320,new Vector3f(0,1,0));
    public static final Quaternion ROT_RIGHT = new Quaternion().fromAngleAxis(-FastMath.PI/320,new Vector3f(0,1,0));
	...
	public static final float MOVE_WALK_SPEED = 0.8f;
    public static final float MOVE_RUN_SPEED = 1.0f;
    public static final float MOVE_BACKWARD_SPEED = 0.3f;

...
public final class Launcher 
{
	...
	private void initBootClassLoader()
	{
		try
		{
			...
			Object environment = loadClientEnvironment(systemClassLoader);
	...
	private Object loadClientEnvironment(ClassLoader loader)
	{
		Object ret = null;
		
		try
		{
			Class<?> c = loader.loadClass(CLIENT_ENVIRONMENT_CLASSNAME);
	...
	private void initClientEnvironment()
	{
		try
		{
			...
			Class<?> envClass = Thread.currentThread().getContextClassLoader().loadClass(CLIENT_ENVIRONMENT_CLASSNAME);
